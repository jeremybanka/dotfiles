$env.PATH = ($env.PATH | split row (char esep) | where { $in != "/Users/jem/Library/Application Support/carapace/bin" } | prepend "/Users/jem/Library/Application Support/carapace/bin")
